...
Route::get('/login/{mensagem?}/{classe?}','App\Http\Controllers\Front\LoginController@login')->name('login');
...
Route::get('/cadastro/{mensagem?}/{classe?}','App\Http\Controllers\Front\CadastroController@cadastro')->name('cadastro');
...
Route::middleware('autenticacao')->group(function(){
    Route::get('/pagina-principal/{mensagem?}/{classe?}','App\Http\Controllers\Front\PrincipalController@index')->name('tela-principal');
