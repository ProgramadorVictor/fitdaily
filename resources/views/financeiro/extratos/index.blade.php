        ...
        <div class="col-12 col-md-10 col-lg-8 col-xl-6 col-xxl-4">
            @foreach($extratos as $extrato)
                <div class="col-12 card my-2 background-black">
                    <h3 class="ms-2 mt-2"><span class="badge text-bg-success">{{$extrato->pagamento->status_de_pagamento}}</span></h3>
                    <div class="card-body">
                        <h5 class="card-title fw-bolder text-white">{{$extrato->assinatura->tipo}}</h5>
                        ...
                        <hr class="col-12 text-white">
                        <h6 class="text-white">R$: <span> {{$extrato->valor}}</span></h6>
                    </div>
                </div>
            @endforeach
        </div>
